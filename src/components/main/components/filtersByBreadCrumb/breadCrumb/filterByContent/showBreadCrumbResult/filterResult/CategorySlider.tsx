...
const CategorySlider = ({ slug, books }: CategorySlider) => {
  // const normalizedSlug = Array.isArray(slug) ? slug.join("-") : slug;
  // const safeSlug = decodeURIComponent(normalizedSlug);
  return (
    <div className="!max-w-[350px] h-full flex flex-col justify-between items-center gap-[12px] sm:!w-full sm:!min-w-full">
